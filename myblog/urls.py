...
from .views import MainView, PostDetailView, SignUpView, SignInView, polynomial_regression_page, gradient_boosting_page, recurrent_neural_network_page  # Импортируйте представление polynomial_regression_page
